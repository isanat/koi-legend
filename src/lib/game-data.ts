...
export const PHASES: GamePhase[] = [
  {
    ...
    cardArt: '/game/cards/card-01-rio-turbulento.png',
    playable: true,
    sceneKey: 'RiverScene',
    color: '#0ea5e9',
    icon: '🌊',
  },
  {
    ...
    reward: 20,
    difficulty: 'facil',
    cardArt: '/game/cards/card-02-predador.png',
    color: '#84cc16',
    icon: '🦅',
  },
  {
  ...
  },
  {
    ...
    reward: 45,
    difficulty: 'medio',
    cardArt: '/game/cards/card-05-redemoinho.png',
    playable: true,
  ...
  },
  {
    ...
    reward: 60,
    difficulty: 'dificil',
    cardArt: '/game/cards/card-07-tempestade.png',
    playable: true,
    sceneKey: 'StormScene',
    color: '#6366f1',
    icon: '⛈️',
  ...
  },
  {
    ...
    reward: 100,
    difficulty: 'lendario',
    cardArt: '/game/cards/card-10-espirito-rio.png',
    color: '#a855f7',
    icon: '✨',
  },
  {
    ...
    reward: 120,
    difficulty: 'lendario',
    cardArt: '/game/cards/card-11-cachoeira-dragao.png',
    playable: true,
  ...
  },
  {
    ...
    reward: 200,
    difficulty: 'lendario',
    cardArt: '/game/cards/card-12-ascensao-dragao.png',
    color: '#eab308',
    icon: '🐉',
  },
];
